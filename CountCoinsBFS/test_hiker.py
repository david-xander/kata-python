...
class TestHiker(unittest.TestCase):
    ...
    def test_15cents_change_first_item(self):
        h = Hiker(15)
        self.assertEqual('15P', h.ways_change()[0])

    def test_15cents_change_complete(self):
        h = Hiker(15)
        self.assertEqual(['15P', '5P and 2N', '5P and 1D', '10P and 1N', '3N', '1N and 1D'], h.ways_change())
